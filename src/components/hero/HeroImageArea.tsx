...
export default function HeroImageArea() {
  return (
    <div className="relative w-full mt-8 md:mt-10 lg:mt-12">
      {/* Image Container */}
      <div className="relative w-full aspect-square sm:aspect-[4/3] md:aspect-[21/9] bg-[#faefd9] rounded-image flex items-center justify-center overflow-hidden border-4 border-brand-dark shadow-[10px_10px_0px_#f01600]">
        <Image
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full md:w-[450px] translate-y-[35%] md:translate-y-[25%] z-10 px-4 md:px-0">
        <HeroForm />
      </div>
