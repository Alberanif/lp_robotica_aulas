...
const SplitText = ({
  ...
  switch (tag) {
    case "h1": return <h1 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h1>;
    case "h2": return <h2 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h2>;
    case "h3": return <h3 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h3>;
    case "h4": return <h4 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h4>;
    case "h5": return <h5 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h5>;
    case "h6": return <h6 ref={ref as React.RefObject<HTMLHeadingElement>} style={style} className={classes}>{text}</h6>;
    default:   return <p ref={ref as React.RefObject<HTMLParagraphElement>} style={style} className={classes}>{text}</p>;
  }
};
